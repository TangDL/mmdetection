...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=(1024,500), keep_ratio=True),
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file="/mmdetection/data/gzx/train_round2/train_coco.json",
        img_prefix="/mmdetection/data/gzx/train_round2/train/",
...
log_level = 'INFO'
work_dir = "/mmdetection/TDL/result/cascade_rcnn_hrnetv2p_w32_20e"
load_from = None
resume_from = None
workflow = [('train', 1)]
